...
export default function SystemSettings() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (settingsData.data?.data && statsData.data?.data) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await apiFetch<{ message?: string }>("/admin/settings", {
        method: "PATCH",
      ...
      if (data?.data) {
        ...
        setError(data?.data?.message || "Failed to update settings");
      }
    } catch (err) {
      setError("Failed to connect to API");
    } finally {
      ...
      <div className="p-8 max-w-none mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <form
              onSubmit={handleSave}
              className="rounded-2xl border border-white/[0.06] bg-[#0c111d] p-8 shadow-xl"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-[rgba(240,244,250,0.4)]">
                    LTD Plan Limit
                  </label>
                  <input
                    type="number"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSettings({ ...settings, professionalLimit: e.target.value })
                    }
                    className="w-full rounded-lg border border-white/[0.08] bg-white/[0.02] px-4 py-2.5 text-sm text-[#f0f4fa] focus:border-[#14b8a6] focus:outline-none focus:ring-1 focus:ring-[#14b8a6] transition"
                  />
                </div>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      onClick={() =>
                        setSettings({
                          ...settings,
                          globalEmailEnabled: !settings.globalEmailEnabled,
                        })
                      }
                    ...
                    <span className="text-sm font-medium text-[#f0f4fa]">
                      {settings.globalEmailEnabled
                        ? "System-wide Emails Enabled"
                        : "All Emails Paused"}
                    </span>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <div className="rounded-2xl border border-white/[0.06] bg-[#0c111d] p-6 shadow-xl">
              ...
              <div className="space-y-6">
                <HealthIndicator
                  ...
                  description="Edge runtime & handlers"
                />
                <HealthIndicator
                  label="Database"
                ...
                <HealthIndicator
                  ...
                  description="Session & Rate limit engine"
                />
              </div>
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-[#0c111d] p-6 shadow-xl">
              ...
              <p className="text-xs text-[rgba(240,244,250,0.4)] mb-6">
                Sensitive platform-wide administrative actions.
              </p>
