...
function PayoutsContent() {
  ...
  const payableItems = payouts.filter(
    (p) => p.stripeConnected && !p.complianceBlocked && p.grossAmount >= payoutMinimum
  );
        ...
        <div className="mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-[rgba(240,244,250,0.5)]">
              Process and track payouts for referral agents.
            </p>
          </div>
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="mt-1 text-xs text-[rgba(240,244,250,0.5)]">
                  Partners eligible for payout (Min. ${payoutMinimum})
                </p>
              </div>
          ...
          <div className="grid gap-4">
            {loading ? (
              <div className="py-12 text-center">
                ...
                <div className="text-xs text-[rgba(240,244,250,0.3)]">
                  Analyzing payout eligibility...
                </div>
              </div>
            ) : payouts.length > 0 ? (
              payouts.map((a) => {
                ...
                const isPayable =
                  a.stripeConnected && !a.complianceBlocked && a.grossAmount >= payoutMinimum;
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-2">
                          <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/[0.03] border border-white/[0.05]">
                            <div
                              className={`h-1.5 w-1.5 rounded-full ${a.stripeConnected ? "bg-[#10b981]" : "bg-[#f43f5e]"}`}
                            ></div>
                            <span className="text-[10px] text-[rgba(240,244,250,0.5)] font-medium">
                              Stripe
                            </span>
                          </div>
                          <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/[0.03] border border-white/[0.05]">
                            <div
                              className={`h-1.5 w-1.5 rounded-full ${a.taxFormCompleted ? "bg-[#10b981]" : "bg-[#f97316]"}`}
                            ></div>
                            <span className="text-[10px] text-[rgba(240,244,250,0.5)] font-medium">
                              W9/1099
                            </span>
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-x-5 gap-y-1">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[10px] text-[rgba(240,244,250,0.5)] uppercase tracking-wider font-semibold">
                            Net Payout:
                          </span>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs font-medium text-[#f0f4fa] font-mono">
                            ${a.grossAmount.toFixed(2)}
                          </span>
                        </div>
                        {a.lastPayoutAt && (
                          <div className="flex items-center gap-1.5">
                            <span className="text-[10px] text-[rgba(240,244,250,0.5)]">
                              Last Paid:
                            </span>
                            <span className="text-xs font-medium text-[rgba(240,244,250,0.7)]">
                    ...
                    <div className="hidden sm:block">
                      <div className="text-right">
                        <div className="text-[10px] text-[rgba(240,244,250,0.3)] uppercase tracking-wider font-bold mb-1">
                          Cycle Availability
                        </div>
              ...
              <div className="rounded-xl border border-dashed border-white/[0.1] py-16 text-center">
                ...
                <div className="text-sm font-medium text-[rgba(240,244,250,0.5)]">
                  No pending payouts found.
                </div>
                <div className="text-xs text-[rgba(240,244,250,0.3)] mt-1">
                  Refresh the queue to check for new eligible partners.
                </div>
              </div>
            )}
          </div>
