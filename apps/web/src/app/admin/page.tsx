...
import { apiFetch, AdminStats, PlatformSettings } from "@/lib/api";
...
export default function AdminDashboard() {
  ...
  const chartData =
    stats?.subscriptionBreakdown?.map((s) => ({
      name:
        (s.subscriptionTier || "free").charAt(0).toUpperCase() +
        (s.subscriptionTier || "free").slice(1),
      count: s._count,
    })) || [];
      ...
      <div className="p-8">
        <header className="mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <p className="text-[rgba(240,244,250,0.5)]">
              High-level overview of OrbisVoice platform performance
            </p>
          </div>
          <button
            onClick={fetchStats}
          ...
          <StatCard
            ...
            icon={
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M3 21h18M3 7v14M21 7v14M12 3L3 7v14M12 3l9 4M12 3v18" />
              </svg>
            }
          />
          <StatCard
            ...
            icon={
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 7a4 4 0 100-8 4 4 0 000 8zm12 14v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" />
              </svg>
            }
          />
          <StatCard
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-[#0c111d] p-6 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-[rgba(240,244,250,0.4)] mt-1">
                    {settings?.emailVerificationEnabled
                      ? "Signup verification is ON"
                      : "Signup verification is OFF"}
                  </p>
                </div>
                <Toggle
              ...
              <div className="pt-4 border-t border-white/[0.05]">
                <p className="text-[10px] uppercase tracking-widest text-[rgba(240,244,250,0.3)] mb-4">
                  Maintenance
                </p>
                <button
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-2xl border p-6 transition group relative overflow-hidden ${
        isHighlight
    ...
    >
      <div className="flex items-center justify-between mb-4 relative z-10">
        <div
          className={`h-10 w-10 rounded-xl flex items-center justify-center ${isHighlight ? "bg-[#14b8a6] text-[#05080f]" : "bg-white/[0.04] text-[rgba(240,244,250,0.6)] group-hover:bg-[#14b8a6]/20 group-hover:text-[#14b8a6]"} transition`}
        >
          {icon}
        </div>
      ...
      <p
        className={`mt-1 text-3xl font-bold relative z-10 ${isHighlight ? "text-[#14b8a6]" : "text-[#f0f4fa]"}`}
      >
        {value}
      </p>
...
function HealthItem({ label, status }: { label: string; status: string | undefined }) {
  ...
  return (
    <div className="flex items-center justify-between py-2.5 group">
      <span className="text-sm text-[rgba(240,244,250,0.7)] group-hover:text-[#f0f4fa] transition">
        {label}
      </span>
      <div className="flex items-center gap-2">
        <span
          className={`h-2 w-2 rounded-full ${isOk ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-rose-500 border border-rose-300"}`}
        />
        <span
          className={`text-xs font-semibold tracking-wide ${isOk ? "text-emerald-500" : "text-rose-500"}`}
        >
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-xs text-[rgba(240,244,250,0.4)] group-hover:text-[rgba(240,244,250,0.6)] transition">
          {subtitle}
        </p>
      </div>
