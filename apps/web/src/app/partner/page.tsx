...
async function getCommissionRate() {
  try {
    const { data } = await apiFetch<{ commissionRate?: number }>("/affiliates/program-details");
    if (data?.data) {
      return data.data.commissionRate || 30;
    }
  } catch (err) {
    ...
    <div className="flex min-h-screen flex-col bg-[#05080f] text-[#f0f4fa] overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center pt-32 pb-20 px-6 text-center z-10">
        ...
        <p className="max-w-2xl text-lg md:text-xl text-[rgba(240,244,250,0.7)] mb-10 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-150">
          Join our exclusive network of affiliates and agencies. Earn an industry-leading{" "}
          <strong className="text-white">{commissionRate}% lifetime commission</strong> on every
          customer you refer to the platform.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#080c16] border border-white/[0.06] rounded-2xl p-8 hover:border-[#14b8a6]/30 transition-colors group relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-white mb-3">
              {commissionRate}% Lifetime Revenue
            </h3>
            <p className="text-[rgba(240,244,250,0.6)] leading-relaxed">
              You bring the client, we deliver the voice agents. Enjoy a recurring {commissionRate}%
              cut of their subscription fee for as long as they remain a customer. No limits, no
              caps.
            </p>
          </div>
          ...
          <div className="bg-[#080c16] border border-white/[0.06] rounded-2xl p-8 hover:border-[#3b82f6]/30 transition-colors group relative overflow-hidden">
            ...
            <p className="text-[rgba(240,244,250,0.6)] leading-relaxed">
              Track your clicks, conversions, and pending payouts through a dedicated,
              state-of-the-art backend dashboard designed specifically for our affiliates.
            </p>
          </div>
          ...
          <div className="bg-[#080c16] border border-white/[0.06] rounded-2xl p-8 hover:border-[#f59e0b]/30 transition-colors group relative overflow-hidden">
            ...
            <p className="text-[rgba(240,244,250,0.6)] leading-relaxed">
              We&apos;ve partnered with Stripe Connect to automate the flow of your commissions
              directly to your bank account every month. Say goodbye to manual invoicing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative group">
              <div className="mx-auto h-12 w-12 rounded-full bg-[#05080f] border-2 border-[#14b8a6] flex items-center justify-center text-[#14b8a6] font-bold text-lg mb-6 z-10 relative shadow-[0_0_15px_rgba(20,184,166,0.3)]">
                1
              </div>
              <h4 className="text-xl font-semibold text-white mb-3">Apply Quickly</h4>
              <p className="text-sm text-[rgba(240,244,250,0.6)]">
                Fill out our rapid onboarding form using just your name and email to instantly
                generate your unique referral link.
              </p>
            </div>
            <div className="relative group">
              <div className="mx-auto h-12 w-12 rounded-full bg-[#05080f] border-2 border-[#14b8a6] flex items-center justify-center text-[#14b8a6] font-bold text-lg mb-6 z-10 relative">
                2
              </div>
              <h4 className="text-xl font-semibold text-white mb-3">Complete Profile</h4>
              <p className="text-sm text-[rgba(240,244,250,0.6)]">
                Log into your new dashboard to fill in your secure payout info (Stripe Connect) and
                upload your tax documentation.
              </p>
            </div>
            <div className="relative group">
              <div className="mx-auto h-12 w-12 rounded-full bg-[#05080f] border-2 border-[#14b8a6] flex items-center justify-center text-[#14b8a6] font-bold text-lg mb-6 z-10 relative shadow-[0_0_15px_rgba(20,184,166,0.3)]">
              ...
              <p className="text-sm text-[rgba(240,244,250,0.6)]">
                Start distributing your link. As soon as a referred user transitions into a paid
                tier, your {commissionRate}% cut locks in automatically.
              </p>
            </div>
          </div>
        </div>
